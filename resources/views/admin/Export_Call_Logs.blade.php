...
<div class="breadcrumb-holder">
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Export Call logs</li>
    </ul>
  </div>
</div>
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-header d-flex align-items-center">
                  <h2 class="h5 display">Export Call logs</h2>
            </div>
          <div class="card-block">
            <ul class="breadcrumb">
              <li class="breadcrumb-item active"> This will help you export all the call logs to an excel file which you can download for your records. </li>
            </ul>
            ...
            @endif
          <form id="eventForm" class="form" role="form" method="POST" action="{{ route('admin.Export_Call_Logs_api') }}">
              {{ csrf_field() }}
              <div class="row">
                <div class="col-md-6">
