  ...
  public function registration(Request $request){
        ...
        $validatedData = $request->validate([
          ...
          if($confirm_password===$password){
              ...
              $response = Curl::to('https://cooperapp.herokuapp.com/registration')
                     ->withData( array( 'email' => $email,'phone' =>$phone,'region' => $region,'password' => $password,'isAdmin' => $isAdmin ) )
